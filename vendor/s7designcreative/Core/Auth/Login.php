...
class Login
{
    ...
    {
        $user = $this->entityManager->getRepository( 'S7D\Core\Auth\Entity\User' )->findOneBy(array(
            'username' => $username,
        ));
    ...
    public function getUser()
    {
        ...
        return $this->entityManager->getRepository( 'S7D\Core\Auth\Entity\User' )->find($user_id);
    }
